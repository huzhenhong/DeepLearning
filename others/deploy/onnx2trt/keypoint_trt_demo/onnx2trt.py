...
def onnx2trt(onnx_model, save_file, input_shapes, fp16=True, device_id=0):
    engine = create_trt_engine(
    ...
    save_trt_engine(engine, save_file)
...
if __name__ == '__main__':
    ...
    onnx_weight = 'model.onnx'
    engine_weight = onnx_weight.replace("onnx", "engine")
    input_shape = {"input": {"min_shape": [1, 3, 448, 448],
                             "opt_shape": [1, 3, 448, 448],
                             "max_shape": [1, 3, 448, 448]}}
    onnx2trt(onnx_model=onnx_weight, save_file=engine_weight, input_shapes=input_shape, fp16=True, device_id=0)
