...
from models.networks import se_resnet50
...
if __name__ == '__main__':
    ...
    parser.add_argument('--model-name', type=str, default='se_resnet50')
    parser.add_argument(
    ...
    parser.add_argument(
        ...
        help='when train,the file will generate in runs/',
    )
