...
def parse_argument():
    ...
    parser.add_argument(
        ...
        help='video1 path',
        # required=True,
        default='/Users/huzh/Documents/github/SAM/segment-anything/samexporter/debug_no_previrous.mp4',
    )
    parser.add_argument(
        '-v2',
        '--video2_path',
    ...
    parser.add_argument(
        ...
        help='save path',
        # required=True,
        default='/Users/huzh/Documents/github/SAM/segment-anything/samexporter/debug_concatenate.mp4',
    )
