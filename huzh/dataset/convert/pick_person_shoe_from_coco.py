...
if __name__ == '__main__':
    ...
    parser.add_argument(
        ...
        '--label_path',
        type=str,
        default='/Users/huzh/Documents/数据集/Objects365-2019-origin/Annotations/train/train.json',
        # default='/Users/huzh/Documents/数据集/Objects365-2019-origin/Annotations/val/val.json',
        # default='/Users/huzh/Documents/数据集/Objects365-2019-origin/Annotations/val/picked_val.json',
    ...
    parser.add_argument(
        ...
        '--img_path',
        type=str,
        default='/Users/huzh/Documents/数据集/Objects365-2019/images/train',
