...
'''
 ...
 LastEditTime : 2023-09-18 11:48:09
 FilePath     : \\DeepLearning\\others\\label_convert\\pick_person_shoe_from_coco.py
...
def main(opt):
    ...
    for img_id in tqdm(all_img_ids):
        ...
        im = cv.imread(os.path.join(opt.img_path, filename + '.jpg'))
        ...
        for i, shoes in person_2_shoes.items():
            ...
            cv.imwrite(
                os.path.join(opt.save_path, 'images', f'{filename}_{i}.jpg'),
                crop,
            )
            ...
            with open(
                os.path.join(opt.save_path, 'labels', f'{filename}_{i}.txt'),
                'w',
            ) as f_writer:
                file_cnt += 1
...
if __name__ == '__main__':
    ...
    parser.add_argument(
        ...
        '--label_path',
        type=str,
        # default='/Users/huzh/Documents/dataset/objects365_2019/Annotations/train/train.json',
        # default='/Users/huzh/Documents/dataset/objects365_2019/Annotations/val/val.json',
        default='/Users/huzh/Documents/dataset/objects365_2019/Annotations/val/person_sneakers_val.json',
    ...
    parser.add_argument(
        ...
        '--img_path',
        type=str,
        # default='/Users/huzh/Documents/dataset/objects365_2019/images/train',
        default='/Users/huzh/Documents/dataset/objects365_2019/Images/val',
        # default='/Users/huzh/Documents/dataset/objects365_2019/images/person_sneakers_val',
        help='image path',
    )
    parser.add_argument(
        '-d',
